...
function button1(){
    ...
    localStorage.setItem("attemptsImpossible", JSON.stringify(attempts));
    ...
    setTimeout(function(){document.getElementById("button").disabled = false},32000);
            ...
            if(document.getElementById("button").disabled = true){
                ...
                picture.onclick = function(){
                    ...
                    zer++;
                    counter[next] = zer;
                    localStorage.setItem("counterImpossible", JSON.stringify(counter))
    ...
    function Data(){
        if(JSON.parse(localStorage.getItem("attemptsImpossible")!=null)){
            attempts = JSON.parse(localStorage.getItem("attemptsImpossible"));
            counter = JSON.parse(localStorage.getItem("counterImpossible"));
            x = attempts.length 
